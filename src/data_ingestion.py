...
class DataIngestion:
    ...
    def download_csv_from_gcp(self):
        try:
            ...
            logger.error('Error while downloaded the csv file')
    ...
    def split_data(self):
        try: 
            ...
            train_data, test_data = train_test_split(data, test_size=1-self.train_test_ratio, random_state=1234)
            ...
            raise CustomException('Failed to split data into train and test sets', sys)
